...
describe('interactions with product and shopping bag', () => {
    beforeEach(() => {
        ...
        // Handle redirection using cy.origin()
        cy.origin('https://pointssystemshop.armdev.am', () => {
            // Make assertions or interact with elements on the new domain
            cy.url().should('include', '5-Speed-Hand-Mixer/HD00017720');
        });
    });
